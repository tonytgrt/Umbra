...
\section{Game Design}
    ...
    \subsection{Design Goals}
        ...
        Ambient audio is calm and atmospheric, establishing the mood of a world governed
        by light. Interaction feedback is delivered through crisp sound cues (light source
        drag start/end, blocking object slide) and the continuously animating shadow
        boundary, which gives the player instant visual confirmation of every manipulation.
    ...
    \subsection{Worlds, Characters and Story}
        ...
        % TODO: Describe the level environments, light/shadow regions, and how they
        %       change as light sources and blocking objects are repositioned.
