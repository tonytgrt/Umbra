...
\section{Game Design}
    ...
    \subsection{Design Goals}
        ...
        \subsubsection{Main Design Features}
            ...
            \begin{figure}[h]
                \centering
                \includegraphics[width=\linewidth]{img/TutorialConcept.png}
            \end{figure}
            ...
            \begin{figure}[h]
                \centering
                \includegraphics[width=\linewidth]{img/ButtonConcept.png}
            \end{figure}
    ...
    \subsection{Worlds, Characters and Story}
        ...
        \begin{itemize}[leftmargin=1.5em, itemsep=4pt]
            ...
            \item \textbf{Level 1 --- The Collapsed Bridge.} A medium-sized island with a
                  ...
                  \begin{figure}[h]
                    \centering
                    \includegraphics[width=\linewidth]{img/Level1Concept.png}
                \end{figure}
...
\section{Implementation}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=\linewidth]{img/MainMenu.png}
    \end{figure}

    \begin{figure}[h]
        \centering
        \includegraphics[width=\linewidth]{img/MenuSelectLevel.png}
    \end{figure}
